...
import 'package:admin/screens/historia_clinica/shared/widgets/odontopediatria_widget.dart';

class OdontopediatriaScreen extends StatefulWidget {
  const OdontopediatriaScreen({Key? key}) : super(key: key);

  @override
  State<OdontopediatriaScreen> createState() => _OdontopediatriaScreenState();
}

class _OdontopediatriaScreenState extends State<OdontopediatriaScreen> {
  ...
  Future<void> _seleccionarPaciente(Map<String, dynamic> paciente) async {
    ...
    try {
      ...
      final registros = await _apiService.fetchRegistrosHistoriaClinica(
        ...
        tipoRegistro: 'clinica_odontopediatria',
      );
  ...
  Future<void> _guardar() async {
    ...
    try {
      final dataToSave = {
        ...
        'materia': 'odontopediatria',
        'tipo_registro': 'clinica_odontopediatria',
        'datos': _data,
        'estado': 'pendiente',
      };
      ...
      if (_registroId != null) {
        ...
        _mostrarExito('Clínica Odontopediatría actualizada correctamente');
      } else {
        ...
        _mostrarExito('Clínica Odontopediatría guardada correctamente');
      }
    } catch (e) {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Información clínica del paciente pediátrico',
                        style: TextStyle(
                          fontSize: 14,
